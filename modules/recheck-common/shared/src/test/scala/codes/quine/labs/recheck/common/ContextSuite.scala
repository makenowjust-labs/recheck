...
class ContextSuite extends munit.FunSuite {
  ...
  test("Context#interrupt") {
    ...
    interceptMessage[CancelException](
      "cancel at modules/recheck-common/shared/src/test/scala/codes/quine/labs/recheck/common/ContextSuite.scala:27"
    )(ctx.interrupt(42))
    interceptMessage[TimeoutException](
      "timeout at modules/recheck-common/shared/src/test/scala/codes/quine/labs/recheck/common/ContextSuite.scala:30"
