...
object arguments:
  ...
  given durationArgument: Argument[Duration] with
  ...
  given checkerArgument: Argument[Checker] with
  ...
  given accelerationModeArgument: Argument[AccelerationMode] with
  ...
  given seederArgument: Argument[Seeder] with
