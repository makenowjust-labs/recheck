...
To enable the plugin, you should add the following configuration to your `eslint.config.js` (ESlint v9 or later) or `.eslintrc.json` (ESLint v8 or earlier).

<Tabs groupId="eslint-config">
<TabItem value="eslint.config.js" label="eslint.config.js (ESLint v9 or later)">
...
<TabItem value=".eslintrc.json" label=".eslintrc.json (ESLint v8 or earlier)">
