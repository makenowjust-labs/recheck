...
<p style={{textAlign: "center"}}>
  <Image img={require('/img/docs/internals/matching-acceleration/confluence.png')} max={300} width="300px" />
</p>
...
- <a id="davis-2021">[1]</a> Davis, James C., Francisco Servant, and Dongyoon Lee. "Using selective memoization to defeat regular expression denial of service (ReDoS)." <em>2021 IEEE Symposium on Security and Privacy (SP), Los Alamitos, CA, USA</em>. 2021.
