...
<p style={{textAlign: "center"}}>
  <Image img={require('/img/docs/intro/exponential-chart.png')} max={600} width="600px" />
</p>

[**ReDoS**](https://en.wikipedia.org/wiki/ReDoS) (*Regular expression Denials of Services*) is a computation complexity attack using this fact.
...
According to [recent research](https://people.cs.vt.edu/~davisjam/downloads/publications/DavisCoghlanServantLee-EcosystemREDOS-ESECFSE18.pdf), 10% of regular expressions of real uses have ReDoS vulnerability potentially.
